/**
 * Skrypt do dodania nowego akcesorium: podpietka plastikowa
 * 
...
async function addPodpietkaPlastikowa() {
  try {
    ...
    const accessoryData = {
      name: 'Podpietka plastikowa',
      slug: 'podpietka-plastikowa',
      description: 'Podpietka plastikowa z wzorem heksagonalnym, zapewniająca doskonałą przyczepność',
      price: 40.00,
      sku: 'POD-PLASTIK',
      image_src: '/images/accessories/podpietka-plastikowa.webp',
      features: ['Materiał plastikowy', 'Wzór heksagonalny', 'Antypoślizgowa', 'Trwała'],
      in_stock: true,
      stock_quantity: null,
      is_active: true,
      rating: 4.7,
