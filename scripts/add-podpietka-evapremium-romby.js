/**
 * Skrypt do dodania nowego akcesorium: podpietka EVAPREMIUM w romby
 * 
...
async function addPodpietkaEvapremiumRomby() {
  try {
    ...
    const accessoryData = {
      name: 'Podpietka EVAPREMIUM w romby',
      slug: 'podpietka-evapremium-w-romby',
      description: 'Elegancka podpietka EVAPREMIUM z wzorem rombów wykonana z materiału EVA',
      price: 30.00,
      sku: 'POD-EVAPREM-ROMBY',
      image_src: '/images/accessories/podpietka-evapremium-w-romby.webp',
      features: ['Materiał EVA', 'Wzór rombów', 'Premium', 'Trwałe'],
      in_stock: true,
      stock_quantity: null,
      is_active: true,
      rating: 4.8,
