...
const encodeVideoPath = (filename: string) =>
  `/video_carusela/${filename.replaceAll(" ", "%20")}`

export const productVideos: ProductVideo[] = [
  {
    id: "v1",
    src: encodeVideoPath("V1.mp4"),
  ...
  {
    id: "0703-1",
    src: encodeVideoPath("0703(1).mp4"),
  ...
  {
    id: "0703-3-1",
    src: encodeVideoPath("0703 (3)(1).mp4"),
  ...
  {
    id: "0701-1-2",
    src: encodeVideoPath("0701 (1)(2).mp4"),
  ...
  {
    id: "copy-01fab278",
    src: encodeVideoPath("copy_01FAB278-0557-4164-8701-6675268A48C9.MOV"),
  ...
  {
    id: "copy-0e041db3",
    src: encodeVideoPath("copy_0E041DB3-375C-4419-8A26-DC5DAC66CFB5.MOV"),
  ...
  {
    id: "copy-10a1b7a3",
    src: encodeVideoPath("copy_10A1B7A3-5715-4CBB-8B05-432A757CC211.MOV"),
  ...
  {
    id: "copy-1d17cd7f",
    src: encodeVideoPath("copy_1D17CD7F-F14C-4A44-BB90-8DCAB22C431E.MOV"),
  ...
  {
    id: "copy-2546d97a",
    src: encodeVideoPath("copy_2546D97A-CF00-4EE6-A230-2BF4E29AB359.MOV"),
  ...
  {
    id: "copy-6da2874d",
    src: encodeVideoPath("copy_6DA2874D-18AB-49E0-B035-73D595BDF75E (1).MOV"),
    poster: "/galeria/IMG_8951.JPG",
    title: "Profesjonalny montaż",
    alt: "Profesjonalny montaż dywaników EVA Premium",
  },
  {
    id: "copy-8e0de509",
    src: encodeVideoPath("copy_8E0DE509-B731-4F6E-BB89-67D0DBE9662F (1).MOV"),
    poster: "/galeria/IMG_8956.JPG",
    title: "Różne modele",
    alt: "Dywaniki EVA Premium do różnych modeli aut",
  },
  {
    id: "copy-9ab40a7d",
    src: encodeVideoPath("copy_9AB40A7D-C4A5-42BD-9BBC-1C1101A3BE1A.MOV"),
    poster: "/galeria/kosc_sloniowa.jpg",
