...
export { default as ProductGallerySection } from '../../components/product-gallery-section';
export { default as ProductSelection } from '../../components/product-selection';
export { default as ImageCarousel } from '../../components/ImageCarousel';

// Types (tymczasowo z oryginalnych lokalizacji)
export type { Product, ProductConfiguration, ProductPricing, CarDetails } from '../../lib/types/product';
