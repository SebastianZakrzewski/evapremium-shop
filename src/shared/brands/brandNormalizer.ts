...
export const MODELE_IMAGE_MAP: Record<string, string> = {
  ...
  seres: 'seres.jpg',
  skoda: 'skoda.webp',
  skywell: 'skywell.webp',
  smart: 'smart.avif',
  ssangyong: 'ssangyong.png',
  ssang_young: 'ssang_young.jpg',
  subaru: 'subaru.webp',
  suzuki: 'suzuki.avif',
  tesla: 'tesla.avif',
  toyota: 'toyota.webp',
  ...
  jetour: 'Jetour.jpg',
  lada: 'Lada.jpg',
  leapmotor: 'Leapmotor.jpg',
  maybach: 'Maybach.webp',
  morris_register: 'moris-minor.webp',
  rover: 'rover.webp',
  zaz_968: 'zaz_968.webp',
};
...
const BRAND_DEFINITIONS: BrandMeta[] = [
  ...
  { slug: "toyota", apiName: "Toyota", displayName: "Toyota", logo: `${MODELE_LOGO_BASE}/toyota.webp`, aliases: ["toyota"] },
  ...
  { slug: "skoda", apiName: "Skoda", displayName: "Škoda", logo: `${MODELE_LOGO_BASE}/skoda.webp`, aliases: ["skoda", "škoda", "skoda-auto"] },
  ...
  { slug: "fiat", apiName: "Fiat", displayName: "Fiat", logo: `${MODELE_LOGO_BASE}/fiat.webp`, aliases: ["fiat"] },
  ...
  { slug: "chevrolet", apiName: "Chevrolet", displayName: "Chevrolet", logo: `${MODELE_LOGO_BASE}/chevrolet.webp`, aliases: ["chevrolet", "chevy"] },
  { slug: "alfa-romeo", apiName: "Alfa Romeo", displayName: "Alfa Romeo", logo: `${MODELE_LOGO_BASE}/alfa_romeo.webp`, aliases: ["alfa-romeo", "alfa romeo", "alfa_romeo"] },
  { slug: "land-rover", apiName: "Land Rover", displayName: "Land Rover", dbName: "Land rover", logo: `${MODELE_LOGO_BASE}/land_rover.webp`, aliases: ["land-rover", "land rover", "land_rover", "landrover"] },
  {
    slug: "dacia",
    apiName: "Dacia",
    displayName: "Dacia",
    dbName: "Dacia Renault",
    logo: `${MODELE_LOGO_BASE}/dacia.jpg`,
    aliases: ["dacia", "dacia-renault", "dacia renault", "dacia_renault"],
  },
  ...
  { slug: "aixam", apiName: "Aixam", displayName: "Aixam", logo: `${MODELE_LOGO_BASE}/Aixam.webp`, aliases: ["aixam"] },
  ...
  { slug: "mg", apiName: "MG", displayName: "MG", dbName: "MG", logo: `${MODELE_LOGO_BASE}/mg.webp`, aliases: ["mg"] },
  {
    slug: "ssangyong",
    apiName: "SsangYong",
    displayName: "SsangYong",
    dbName: "Ssang Young",
    logo: `${MODELE_LOGO_BASE}/ssangyong.png`,
    aliases: [
      "ssangyong",
      "ssang young",
      "ssang-young",
  ...
  { slug: "forthing", apiName: "Forthing", displayName: "Forthing", dbName: "Forthing", logo: `${MODELE_LOGO_BASE}/forthing.webp`, aliases: ["forthing"] },
  {
    slug: "morris-minor",
    apiName: "Morris Minor",
    displayName: "Morris Minor",
    dbName: "Morris Minor",
    logo: `${MODELE_LOGO_BASE}/moris-minor.webp`,
    aliases: ["morris-minor", "morris minor", "moris_minor", "moris-minor"],
  },
  { slug: "xpeng", apiName: "Xpeng", displayName: "XPeng", dbName: "Xpeng", logo: `${MODELE_LOGO_BASE}/xpeng.png`, aliases: ["xpeng", "x-peng", "x peng"] },
  { slug: "xiaomi", apiName: "Xiaomi", displayName: "Xiaomi", dbName: "Xiaomi", logo: `${MODELE_LOGO_BASE}/xiaomi.png`, aliases: ["xiaomi"] },
