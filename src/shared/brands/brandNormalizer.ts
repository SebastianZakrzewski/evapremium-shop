...
export const MODELE_IMAGE_MAP: Record<string, string> = {
  ...
  moris_minor: 'moris-minor.png',
  morris_minor: 'moris-minor.png',
  ...
  denza: 'Denza.jpg',
  dfsk: 'Dfsk.jpg',
  dongfeng: 'dongfeng.jpg',
  dr: 'Dr.png',
  exlantix: 'exlantix.jpg',
  foton: 'Foton.jpg',
  futuri: 'Futuri.jpg',
  gac: 'Gac.jpg',
  geely: 'Geely.jpg',
  ...
  maybach: 'Maybach.jpg',
  morris_register: 'moris-minor.png',
  rover: 'rover.jpg',
  zaz_968: 'zaz_968.jpg',
};
...
const BRAND_DEFINITIONS: BrandMeta[] = [
  ...
  { slug: "land-rover", apiName: "Land Rover", displayName: "Land Rover", dbName: "Land rover", logo: `${MODELE_LOGO_BASE}/land_rover.png`, aliases: ["land-rover", "land rover", "land_rover", "landrover"] },
  {
    slug: "dacia",
    apiName: "Dacia",
    displayName: "Dacia",
  ...
  { slug: "forthing", apiName: "Forthing", displayName: "Forthing", dbName: "Forthing", logo: `${MODELE_LOGO_BASE}/forthing.png`, aliases: ["forthing"] },
  {
    slug: "morris-minor",
    apiName: "Morris Minor",
    displayName: "Morris Minor",
    dbName: "Morris Minor",
    logo: `${MODELE_LOGO_BASE}/moris-minor.png`,
