    ...
    <footer className="bg-neutral-950 relative pt-20 pb-10 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-3">
            ...
            <ul className="space-y-4">
              <li className="group">
                <span className="block text-xs uppercase text-gray-500 mb-1 tracking-wide">Email</span>
              ...
              <li>
                <span className="block text-xs uppercase text-gray-500 mb-1 tracking-wide">Adres</span>
        ...
        <div className="border-t border-white/10 py-8">
          <h3 className="text-gray-500 text-xs font-bold uppercase tracking-widest text-center mb-6">Bezpieczne płatności</h3>
