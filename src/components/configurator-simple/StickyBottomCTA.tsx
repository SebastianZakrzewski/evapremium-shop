...
export function StickyBottomCTA({
  ...
  return (
    <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-black/95 backdrop-blur-xl border-t border-white/10 shadow-2xl animate-in slide-in-from-bottom-full duration-300 pb-safe">
      {/* Progress Bar */}
        ...
        {(dynamicPreviewPath || productPreviewPath) && (
          <div className="flex items-center gap-3 mb-3 pb-3 border-b border-white/5">
            <button
              ...
              className="relative w-12 h-12 bg-neutral-900 rounded-lg border border-white/10 overflow-hidden shadow-inner flex-shrink-0 active:scale-95 transition-transform"
            >
              <Image
