...
export const StepAccordion = React.forwardRef<HTMLDivElement, StepAccordionProps>(({
  ...
  return (
    ...
    >
      <button
        onClick={onToggle}
        className="w-full flex items-center justify-between p-2.5 md:p-3 text-left hover:bg-white/5 transition-colors duration-200 min-h-[40px] md:min-h-[44px] active:bg-white/5/70"
      >
