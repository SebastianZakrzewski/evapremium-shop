/**
 * Skrypt do pobierania deali używając starej metody crm.deal.list
 * z poprawną konfiguracją zgodnie z dokumentacją Bitrix24
 */
...
/**
 * Pobierz deali z konkretnego etapu i kategorii (stara metoda)
 */
...
async function main() {
  try {
    log(`🚀 Pobieranie deali używając starej metody crm.deal.list`, 'bright');
